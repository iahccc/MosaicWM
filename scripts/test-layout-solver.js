...
function assertValidSlots(solution, bounds, contentRect = solution.contentRect ?? solution.maximizedRect) {
...
function testProfiles() {
    ...
    assert.equal(miniatureTargetSize(MiniatureLayoutProfile.MAXIMIZED_FOCUSED, 256), 128);
...
function testFocusedMaximizedExpandsMainArea() {
    ...
    const compactTarget = miniatureTargetSize(MiniatureLayoutProfile.MAXIMIZED_FOCUSED, 256);
...
function main() {
    ...
    console.log('[LAYOUT SOLVER TEST] PASS: unified centered rail cluster, stable ties, compact maximized profile, bounds and overlap invariants');
}
